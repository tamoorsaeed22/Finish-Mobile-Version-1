...
# 📖 [Finish-Mobile-Version 1] <a name="about-project"></a>



**[Finish-Mobile-Version 1]** In this project, i Have set up a "Hello Microverse Project" repository. No complex coding in this project.I will be using tools in all Microverse projects and most likely in future job as well, so it is important to know them!
